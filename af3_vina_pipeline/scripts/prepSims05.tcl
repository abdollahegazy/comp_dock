...
segment P {pdb ../Data/$species/alphafold_$uid.pdb}
coordpdb ../Data/$species/alphafold/$uid.pdb P
guesscoord
mkdir -p ../Simulations/$species/equilibration/$uid
...
mol new ../Data/$species/alphafold_$uid.pdb
...
cp -r equil/eq.sh ../Simulations/$species/equilibration/$uid/
cp -r equil/eq2.sh ../Simulations/$species/equilibration/$uid/
cp -r equil/run.sh ../Simulations/$species/equilibration/$uid/
cp -r equil/eq.namd ../Simulations/$species/equilibration/$uid/
cp -r equil/eq2.namd ../Simulations/$species/equilibration/$uid/
cp -r equil/run.namd ../Simulations/$species/equilibration/$uid/
cp -r equil/toppar ../Simulations/$species/equilibration/$uid/
